      ...
      <div class="mx-auto max-w-screen-xl">
        <div class="lg:flex lg:justify-between">
          ...
          <div class="grid grid-cols-2 mt-20 gap-5xl sm:grid-cols-3 lg:mt-0 md:mt-10 sm:gap-8xl">
            <div>
              <h2
                class="mb-6 text-sm text-gray-900 font-semibold uppercase"
              >
                Resources
              </h2>
            ...
            <div>
              ...
              <ul class="text-gray-600">
                ...
                <li>
                  <a href="https://www.instagram.com/mytransactx/" target="_blank" rel="noopener noreferrer" class="hover:underline">Instagram</a>
                </li>
              </ul>
            </div>
            <div>
