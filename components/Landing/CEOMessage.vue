...
<template>
  <section class="relative isolate mt-20 overflow-hidden bg-white px-6 py-20 lg:px-8 sm:py-28">
    <div class="mx-auto max-w-2xl lg:max-w-4xl" data-aos="fade-up" data-aos-duration="1000">
      ...
      <figure class="mt-10">
        ...
        <figcaption class="mt-10">
          <div class="mt-4 flex items-center justify-center text-base space-x-3">
            <div class="tx-text-primary font-semibold">
              Akinlawon Dada
            </div>
