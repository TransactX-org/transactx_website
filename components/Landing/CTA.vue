<template>
  <div class="bg-white">
    <div class="mx-auto my-20 max-w-7xl lg:px-8 sm:px-6 sm:py-32" data-aos="fade-up" data-aos-duration="1000">
      <div class="tx-bg-primary relative isolate overflow-hidden px-6 pt-16 shadow-xl lg:flex lg:gap-x-20 sm:rounded-3xl lg:px-24 sm:px-16 lg:pt-0 md:pt-24">
        <svg viewBox="0 0 1024 1024" class="[mask-image:radial-gradient(closest-side,white,transparent)] absolute left-1/2 top-1/2 h-[64rem] w-[64rem] lg:left-1/2 sm:left-full -z-10 lg:ml-0 -translate-y-1/2 lg:translate-y-0 sm:-ml-80 lg:-translate-x-1/2" aria-hidden="true">
        ...
        <div class="relative mt-16 h-80 lg:mt-8" data-aos="fade-left" data-aos-delay="1000" data-aos-duration="1000">
          <img class="absolute left-15 top-0 max-w-none w-[17rem] rounded-md bg-white/1 ring-1 ring-white/10 lg:left-0 sm:w-[27rem]" src="/request-money.png" alt="TransactX App Screenshot" width="1824" height="1080">
        </div>
      </div>
    </div>
  </div>
