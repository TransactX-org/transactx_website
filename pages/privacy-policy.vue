...
// Privacy Policy page
useHead({
  title: 'Privacy Policy - TransactX',
  meta: [
    { name: 'description', content: 'TransactX Privacy Policy - Learn how we collect, use, and protect your personal information.' },
  ],
})
</script>
          ...
          <div class="space-y-12">
              ...
              <div class="space-y-6">
                <div>
                  ...
                  <ul class="ml-4 list-disc list-inside text-gray-700 space-y-1">
                    ...
                    <li>Bank Verification Number (BVN) and account details</li>
                    <li>Residential or business address</li>
                    <li>Identity verification documents (e.g., NIN, driver's license, passport)</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul class="ml-4 list-disc list-inside text-gray-700 space-y-1">
                    <li>Linked bank account information</li>
                    <li>Transaction records (payments, transfers, bill payments, deposits, withdrawals)</li>
                    <li>Wallet and sub-account details</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul class="ml-4 list-disc list-inside text-gray-700 space-y-1">
                    ...
                    <li>Operating system and mobile identifiers</li>
                    <li>Usage logs, cookies, and analytics data</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul class="ml-4 list-disc list-inside text-gray-700 space-y-1">
                    <li>Messages, feedback, or support requests you send to us</li>
                    <li>Responses to surveys, promotions, or research activities</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul class="ml-4 list-disc list-inside text-gray-700 space-y-2">
                <li>Create and manage your TransactX account</li>
                <li>Process payments, bill settlements, and transfers</li>
                <li>Provide real-time transaction monitoring and reporting</li>
            ...
            <section>
              ...
              <ul class="ml-4 list-disc list-inside text-gray-700 space-y-2">
                <li>Financial institutions and payment partners to process transactions</li>
                <li>Technology and infrastructure providers that help us operate the Platform</li>
                <li>Regulatory authorities and law enforcement agencies when required by law</li>
                <li>Affiliated service providers (for KYC, fraud detection, analytics, etc.)</li>
              </ul>
            ...
            <section>
              ...
              <ul class="ml-4 list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>Secure socket layer (SSL) connections</li>
                <li>Multi-factor authentication</li>
                <li>Regular security audits and vulnerability checks</li>
              </ul>
              <p class="mt-4 text-gray-700">
                However, no online system is 100% secure. You are encouraged to protect your login credentials and report suspicious activity immediately.
              </p>
            </section>
            ...
            <section>
              ...
              <p class="mb-4 text-gray-700">
                Depending on applicable law (e.g., NDPR, GDPR), you have the right to:
              </p>
              <ul class="ml-4 list-disc list-inside text-gray-700 space-y-2">
              ...
              <p class="mt-4 text-gray-700">
                To exercise these rights, contact us at <a href="mailto:privacy@mytransactx.com" class="text-blue-600 underline hover:text-blue-800">privacy@mytransactx.com</a>.
              </p>
            </section>
            ...
            <section>
              ...
              <p class="text-gray-700">
                If your data is transferred or stored outside Nigeria, we ensure adequate protection measures are in place consistent with applicable data protection laws.
              </p>
            </section>
            ...
            <section>
              ...
              <p class="text-gray-700">
                Our services are not intended for individuals under 18 years. We do not knowingly collect information from minors. If we discover that a child's data has been provided, we will delete it immediately.
              </p>
            </section>
            ...
            <section>
              ...
              <p class="text-gray-700">
                We may update this Privacy Policy from time to time. Changes will be posted here with the updated "Effective Date." We encourage you to review it regularly.
              </p>
            </section>
            ...
            <section>
              ...
              <div class="rounded-lg bg-gray-50 p-6">
                ...
                <p class="mb-1 text-gray-700">
                  <strong>Email:</strong>
                  <a href="mailto:privacy@mytransactx.com" class="text-blue-600 underline hover:text-blue-800">privacy@mytransactx.com</a>
                </p>
                <p class="text-gray-700">
